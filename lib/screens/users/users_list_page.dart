...
class _UsersListPageState extends State<UsersListPage> {
            ...
            SizedBox(
              ...
              child: ListView(
                ...
                children: [
                  ...
                  const SizedBox(width: 8),
                  _buildChip(l10n.pending_filter, _UserStatus.pending, count: pendingCount),
                  const SizedBox(width: 8),
                  _buildChip(l10n.validated_filter, _UserStatus.verified, count: verifiedCount),
                  const SizedBox(width: 8),
  ...
  Widget _roleBadge(int roleID, AppLocalizations l10n) {
    ...
    switch (role) {
      case AppRole.admin:
        label = l10n.admin_role_label; bg = AppColors.brandSurface; break;
      case AppRole.superAdmin:
        label = l10n.super_admin_role_label; bg = AppColors.accentLight; break;
      case AppRole.microRestaurant:
        label = l10n.resto_role_label; bg = AppColors.successLight; break;
      case AppRole.livreur:
        label = l10n.livreur_role_label; bg = AppColors.surfaceWarm; break;
      default:
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Row(children: [
                          ...
                          const SizedBox(width: 4),
                          Text(
                            isVerified ? l10n.profile_validated : isRejected ? l10n.profile_rejected : l10n.profile_pending,
                            style: TextStyle(
                              fontSize: 11,
