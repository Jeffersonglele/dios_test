...
class PrivacyPolicyPageFR extends StatelessWidget {
  const PrivacyPolicyPageFR({super.key});
    ...
    return Scaffold(
      ...
      body: SingleChildScrollView(
        ...
        child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
          ...
          _Section('5. DESTINATAIRES DES DONNÉES',
          ...
          _Section("6. DURÉE DE CONSERVATION",
          ...
          _Section('9. COOKIES ET TRACEURS',
              "L'application utilise des cookies techniques strictement nécessaires à son fonctionnement. Aucun cookie publicitaire ou de tracking tiers n'est utilisé sans consentement préalable. Vous pouvez désactiver les cookies dans les paramètres de votre appareil."),
          _Section('10. NOTIFICATION DE VIOLATION',
              "En cas de violation de données personnelles, nous notifierons les autorités compétentes (CNIL en France, ARTCI en Côte d'Ivoire, APDP au Bénin) dans les 72 heures, et les personnes concernées si la violation présente un risque élevé pour leurs droits et libertés."),
          _Section("11. DÉLÉGUÉ À LA PROTECTION DES DONNÉES",
              "Pour toute question relative à la protection des données, contactez le DPO :\nEmail : dpo@diosdelices.com\nAdresse postale : à communiquer sur demande."),
          _Section('12. RÉCLAMATIONS',
          ...
          _Section('13. MODIFICATIONS',
              "Cette politique peut être modifiée. Les utilisateurs seront informés des changements majeurs. Dernière mise à jour : juin 2026."),
