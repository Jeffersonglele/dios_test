    ...
    return Scaffold(
      ...
      body: SingleChildScrollView(
        ...
        child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
          ...
          _Section('9. COOKIES AND TRACKERS',
              "The application uses technical cookies strictly necessary for its operation. No advertising or third-party tracking cookies are used without prior consent. You can disable cookies in your device settings."),
          _Section('10. BREACH NOTIFICATION',
              "In the event of a personal data breach, we will notify the competent authorities (CNIL in France, ARTCI in Côte d'Ivoire, APDP in Benin) within 72 hours, and affected individuals if the breach poses a high risk to their rights and freedoms."),
          _Section("11. DATA PROTECTION OFFICER",
              "For any questions regarding data protection, contact the DPO:\nEmail: dpo@diosdelices.com\nPostal address: to be communicated upon request."),
          _Section('12. COMPLAINTS',
          ...
          _Section('13. CHANGES',
              "This policy may be modified. Users will be informed of major changes. Last updated: June 2026."),
