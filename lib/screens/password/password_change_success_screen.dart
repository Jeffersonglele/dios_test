        ...
        child: Center(
          child: Padding(
            ...
            child: Column(mainAxisAlignment: MainAxisAlignment.center, children: [
              ...
              Text(AppLocalizations.of(context)!.password_reset_success_title, style: AppTypography.headlineMedium(), textAlign: TextAlign.center),
              const SizedBox(height: 12),
              Text(AppLocalizations.of(context)!.password_reset_success_body, style: AppTypography.bodyLarge(color: inkMuted), textAlign: TextAlign.center),
              ...
              SizedBox(width: double.infinity, height: 56,
                child: ElevatedButton(
                  ...
                  onPressed: () => Navigator.pushAndRemoveUntil(context, MaterialPageRoute(builder: (_) => const AnimatedSplashScreen()), (_) => false),
