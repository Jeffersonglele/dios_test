      ...
      appBar: AppBar(
        title: Row(children: [
          ...
          Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
            Text(widget.withUsername ?? AppLocalizations.of(context)!.messages,
    ...
    if (conversations.isEmpty) {
      return Center(
        child: Column(mainAxisAlignment: MainAxisAlignment.center, children: [
          ...
          Text(AppLocalizations.of(context)!.chat_no_conversations, style: AppTypography.bodyMedium()),
          const SizedBox(height: 4),
          Text(AppLocalizations.of(context)!.chat_placeholder,
      ...
      itemBuilder: (_, i) {
        ...
        return Container(
          ...
          child: ListTile(
            ...
            title: Text(c['username'] ?? AppLocalizations.of(context)!.chat_unknown,
              ...
              ? Center(
                  child: Column(
                      ...
                      children: [
                        ...
                        Text(AppLocalizations.of(context)!.chat_first_message,
