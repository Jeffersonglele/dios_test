import 'package:dios_delices/screens/UserOrdersPage.dart';
import 'package:dios_delices/screens/DishDetails.dart';
import 'package:dios_delices/l10n/app_localizations.dart';
import 'package:dios_delices/screens/dish/DishFormPage.dart';
          ...
          child: _isLoading
              ...
              : CustomScrollView(
                  ...
                  slivers: [
                    // ── Header hero ───────────────────────
                    SliverToBoxAdapter(
                        child: _HeroHeader(restaurant: _restaurant, country: _country)),
                ...
                children: [
                  ...
                  if (restaurant != null) ...[
                    ...
                    _MetaChip(
                      ...
                      label:
                          '${CurrencyUtil.formatPrice(restaurant!.deliveryFee, country)} livraison',
                    ),
                    const SizedBox(height: 4),
                    _MetaChip(
