                      ...
                      children: [
                        ...
                        Row(children: [
                          Expanded(
                            child: Row(
                              children: [
                                Flexible(
                                  child: Text(current_restaurant!.name ?? '',
                          ...
                          Container(
                            ...
                            child: Text(
                                openingStatus.isOpen ? l10n.open : l10n.closed,
                                style: TextStyle(
                                  color: openingStatus.isOpen
                                      ? AppColors.success
                                      : AppColors.error,
                        ...
                        if (current_restaurant!.note > 0)
                          Padding(
                            ...
                            child: Row(children: [
                              ...
                              Text(current_restaurant!.note.toStringAsFixed(1),
                        ...
                        if ((current_restaurant!.location ?? '').isNotEmpty)
                          Padding(
                            ...
                            child: Row(children: [
                              ...
                              const SizedBox(width: 6),
                              Expanded(
                                  child: Text(current_restaurant!.location!,
                                      style: AppTypography.bodyMedium(
                                          color: AppColors.resolve(
                                              AppColors.inkSubtle,
                                              AppDarkColors.inkSubtle)),
                        ...
                        Row(children: [
                          Icon(Icons.access_time_rounded,
                              size: 16, color: AppColors.inkSubtle),
                          const SizedBox(width: 6),
                          Text(current_restaurant!.openingHours,
                              style: AppTypography.bodyMedium(
                          ...
                          Flexible(
                              child: Text(current_restaurant!.openingDays,
                                  style: AppTypography.bodyMedium(
                                      color: AppColors.resolve(
                                          AppColors.inkSubtle,
                                          AppDarkColors.inkSubtle)),
                        ...
                        // Description
                        Text(current_restaurant!.description ?? '',
                        ...
                        Container(
                          ...
                          child: Row(children: [
                            Text(l10n.restaurant_details_menu,
                                style: AppTypography.titleMedium(
                                    color: AppColors.resolve(
                                        AppColors.ink, AppDarkColors.ink))),
                            const SizedBox(width: 8),
                            Text(
                                l10n.restaurant_details_dish_count(
                                    dishes.length),
                                style: AppTypography.bodyMedium(
                        ...
                        if (current_restaurant != null) ...[
                          Container(
                            ...
                            child: Text(l10n.restaurant_details_reviews,
                                style: AppTypography.titleMedium(
                                    color: AppColors.resolve(
                                        AppColors.ink, AppDarkColors.ink))),
                          ),
