...
import '../onboarding/ConfirmationPage.dart';
...
class _RestaurantFormPageState extends ConsumerState<RestaurantFormPage> {
  ...
  Widget build(BuildContext context) {
    ...
    return GestureDetector(
      ...
      child: Scaffold(
        appBar: AppBar(
          title: Text(widget.isEditing ? AppLocalizations.of(context)!.restaurant_form_title_edit : AppLocalizations.of(context)!.restaurant_form_title_create),
          leading: IconButton(
            ...
            child: Form(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Text(AppLocalizations.of(context)!.restaurant_form_section_restaurant, style: kLoginTitleStyle(size)),
                  const SizedBox(height: 20),

                  _buildTextField(
                    controller: _nameController,
                    hintText: AppLocalizations.of(context)!.restaurant_form_name_hint,
                    icon: Icons.restaurant,
                    validator: (v) {
                      if (v == null || v.isEmpty) return AppLocalizations.of(context)!.restaurant_form_name_required;
                      if (v.length < 4) return AppLocalizations.of(context)!.restaurant_form_name_min_length;
                      return null;
                    },
                  ),
                  ...
                  _buildTextField(
                    ...
                    hintText: AppLocalizations.of(context)!.restaurant_form_desc_hint,
                    icon: Icons.info,
                    maxLines: null,
                    keyboardType: TextInputType.multiline,
                    validator: (v) {
                      if (v == null || v.isEmpty) return AppLocalizations.of(context)!.restaurant_form_desc_required;
                      return null;
                    },
                  ),
                  SizedBox(height: size.height * 0.015),
      ...
      children: [
        Expanded(
          child: _buildTextField(
            ...
            hintText: AppLocalizations.of(context)!.restaurant_form_address_hint,
            icon: Icons.location_city,
            validator: (v) {
              if (v == null || v.isEmpty) return AppLocalizations.of(context)!.restaurant_form_address_required;
              if (v.length < 4) return AppLocalizations.of(context)!.restaurant_form_name_min_length;
              return null;
            },
          ),
        ...
        Padding(
          ...
          child: _isDetecting
              ...
              : IconButton(
                  ...
                  tooltip: AppLocalizations.of(context)!.restaurant_form_detect_position,
      ...
      children: [
        Row(
          children: [
            ...
            Text(AppLocalizations.of(context)!.restaurant_form_opening_days, style: Theme.of(context).textTheme.titleSmall),
          ],
        ),
    ...
    return Container(
      ...
      child: Row(
        children: [
          ...
          Text(AppLocalizations.of(context)!.restaurant_form_opening_hours, style: Theme.of(context).textTheme.titleSmall?.copyWith(color: onSurface)),
          const Spacer(),
          GestureDetector(
      ...
      children: [
        Padding(
          ...
          child: Row(
            children: [
              ...
              const SizedBox(width: 8),
              Text(AppLocalizations.of(context)!.restaurant_form_pickup_mode, style: Theme.of(context).textTheme.titleSmall),
            ],
          ),
        ),
        const SizedBox(height: 8),
        Wrap(
          ...
          children: [
            ...
            _ModeChip(
              value: 'pickup',
              label: AppLocalizations.of(context)!.restaurant_form_mode_takeaway,
            ...
            _ModeChip(
              value: 'both',
              label: AppLocalizations.of(context)!.restaurant_form_mode_both,
    ...
    return Center(
      child: Column(children: [
        if (displayFile != null)
          ...
          Text(AppLocalizations.of(context)!.restaurant_form_no_image, style: const TextStyle(fontWeight: FontWeight.bold)),
        const SizedBox(height: 10),
        ElevatedButton(
          onPressed: _pickImage,
          child: Text(AppLocalizations.of(context)!.restaurant_form_select_image),
        ),
      ]),
    );
  }
        ...
        onPressed: () async {
          ...
          try {
            ...
            if (widget.isEditing && addressText == (widget.restaurant?.location ?? '')) {
              ...
              if (context.mounted) Toast(context, AppLocalizations.of(context)!.restaurant_form_address_invalid, false);
              return;
            }

            final session = await SessionService.readSession();
            if (session.userId == 0) {
              if (context.mounted) Toast(context, AppLocalizations.of(context)!.restaurant_form_user_not_connected, false);
              return;
            }
