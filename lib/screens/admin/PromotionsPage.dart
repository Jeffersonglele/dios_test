...
class _PromotionsPageState extends State<PromotionsPage> {
  ...
  String _fmtDiscount(Map<String, dynamic> code) {
    final type = code['discountType'] as String?;
    final pct = code['discountPercent'];
    final fixed = code['discountFixed'];
    if (type == 'percentage' || pct != null) {
      return '-${pct ?? 0}%';
    }
    if (type == 'fixed' || fixed != null) {
      return '-${CurrencyUtil.formatPrice((fixed ?? 0).toDouble(), _country)}';
    }
    final amount = code['discountAmount'];
    if (amount != null) {
      final amt = (amount as num).toDouble();
      if (code['discountType'] == 'percentage') return '-$amt%';
      return '-${CurrencyUtil.formatPrice(amt, _country)}';
    }
    return '—';
  }
  ...
  bool _isActive(Map<String, dynamic> code) {
    ...
    final validUntil = code['validUntil'] ?? code['expiresAt'];
    if (validUntil != null) {
      DateTime? until;
              ...
              child: Column(
                ...
                children: [
                  ...
                  TextFormField(
                    ...
                    validator: (v) =>
                        (v == null || v.trim().isEmpty) ? AppLocalizations.of(context)!.promo_required : null,
                  ),
                  const SizedBox(height: AppSpacing.md),
                  DropdownButtonFormField<String>(
                    value: discountType,
                    decoration: InputDecoration(
                      labelText: AppLocalizations.of(context)!.promo_discount_type,
                      prefixIcon: const Icon(Icons.percent_rounded, size: 20),
                    ),
                    items: [
                      DropdownMenuItem(
                          value: 'percentage', child: Text(AppLocalizations.of(context)!.promo_percentage)),
                      DropdownMenuItem(
                          value: 'fixed', child: Text(AppLocalizations.of(context)!.promo_fixed_amount)),
                    ],
                    onChanged: (v) {
                  ...
                  GestureDetector(
                    ...
                    child: AbsorbPointer(
                      child: TextFormField(
                        decoration: InputDecoration(
                          labelText: AppLocalizations.of(context)!.promo_valid_from,
                          prefixIcon:
                          ...
                          hintText: validFrom != null
                              ? '${validFrom!.day.toString().padLeft(2, '0')}/'
                                  ...
                                  '${validFrom!.year}'
                              : AppLocalizations.of(context)!.promo_select_date,
                        ),
                      ),
                    ),
                  ),
                  ...
                  GestureDetector(
                    ...
                    child: AbsorbPointer(
                      child: TextFormField(
                        decoration: InputDecoration(
                          labelText: AppLocalizations.of(context)!.promo_valid_until,
                          prefixIcon:
                  ...
                  TextFormField(
                    controller: descCtrl,
                    decoration: InputDecoration(
                      labelText: AppLocalizations.of(context)!.promo_description,
                      prefixIcon:
                  ...
                  SizedBox(
                    ...
                    child: ElevatedButton(
                      onPressed: () async {
                        ...
                        final result = await PromoService.createPromoCode(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      ElevatedButton.icon(
                        ...
                        label: Text(AppLocalizations.of(context)!.promo_create_code),
                      ),
                    ],
                  ),
                )
                          ...
                          child: Column(
                            ...
                            children: [
                              Row(
                                children: [
                                  ...
                                  Container(
                                    ...
                                    child: Text(
                                      active ? AppLocalizations.of(context)!.promo_active : AppLocalizations.of(context)!.promo_inactive,
                              ...
                              Row(children: [
                                ...
                                const SizedBox(width: 6),
                                Text(
                                  'Min. ${code['minOrder'] != null ? '${CurrencyUtil.formatPrice((code['minOrder'] as num).toDouble(), _country)}' : '—'}',
                                  style: AppTypography.bodyMedium(
                                      color: AppColors.resolve(
                                          AppColors.inkMuted,
                              ...
                              Row(children: [
                                ...
                                const SizedBox(width: 6),
                                Text(
                                  'Du ${_fmtDate(code['validFrom'] ?? code['createdAt'])} '
                                  'au ${_fmtDate(code['validUntil'] ?? code['expiresAt'])}',
                              ...
                              if (code['description'] != null &&
                                  (code['description'] as String).isNotEmpty) ...[
                                const SizedBox(height: AppSpacing.sm),
                                Text(
