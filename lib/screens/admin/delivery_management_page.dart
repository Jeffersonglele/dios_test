...
class DeliveryManagementPage extends StatefulWidget {
  ...
  const DeliveryManagementPage({super.key, this.country});
...
class _DeliveryManagementPageState extends State<DeliveryManagementPage>
  ...
  Future<void> _validate(Map<String, dynamic> doc) async {
    ...
    final ok = await showDialog<bool>(
      ...
      builder: (ctx) => AlertDialog(
        title: Text(l10n.admin_delivery_validate),
        content: TextField(
          controller: remarkController,
          decoration: InputDecoration(
            hintText: '${l10n.admin_delivery_remark_hint} (${l10n.optional})',
          ),
          maxLines: 2,
        ),
        actions: [
          ...
          ElevatedButton(
            ...
            child: Text(l10n.admin_delivery_validate),
          ),
        ],
      ),
    );
  ...
  Future<void> _reject(Map<String, dynamic> doc) async {
    ...
    final ok = await showDialog<bool>(
      context: context,
      builder: (ctx) => AlertDialog(
        title: Text(l10n.admin_delivery_reject),
        content: Form(
          key: formKey,
          child: TextFormField(
            controller: remarkController,
            ...
            decoration:
                InputDecoration(hintText: l10n.admin_delivery_remark_hint),
            maxLines: 2,
          ),
        ),
        actions: [
          ...
          ElevatedButton(
            ...
            style: ElevatedButton.styleFrom(
                ...
                foregroundColor: Colors.white),
            child: Text(l10n.admin_delivery_reject),
          ),
        ],
      ),
    );
  ...
  Widget _buildCard(Map<String, dynamic> doc) {
    ...
    final hasDocs = (doc['idCardUrl'] as String?)?.isNotEmpty == true ||
        (doc['licenseUrl'] as String?)?.isNotEmpty == true;
      ...
      child: Column(
        ...
        children: [
          ...
          if (hasDocs) ...[
            ...
            Row(
              children: [
                if ((doc['idCardUrl'] as String?)?.isNotEmpty == true)
                  _DocLink(
                      label: l10n.admin_delivery_id_card,
                      url: doc['idCardUrl']),
                if ((doc['licenseUrl'] as String?)?.isNotEmpty == true)
                  _DocLink(
                      label: l10n.admin_delivery_license,
                      url: doc['licenseUrl']),
              ],
            ),
          ],
              ...
              children: [
                Expanded(
                  child: OutlinedButton.icon(
                    ...
                    label: Text(l10n.admin_delivery_reject),
                ...
                Expanded(
                  child: ElevatedButton.icon(
                    ...
                    label: Text(l10n.admin_delivery_validate),
                    style: ElevatedButton.styleFrom(
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        bottom: TabBar(
          ...
          tabs: [
            Tab(text: '${l10n.admin_delivery_requests_pending} ($pending)'),
            Tab(text: '${l10n.admin_delivery_requests_validated} ($validated)'),
            Tab(text: '${l10n.admin_delivery_requests_rejected} ($rejected)'),
          ],
        ),
      ),
      body: _loading
        ...
        child: Container(
          ...
          child: Row(
            ...
            children: [
              ...
              Text(l10n.admin_delivery_view_document,
