import 'package:dios_delices/screens/legal/LegalPage.dart';
import 'package:dios_delices/screens/legal/PrivacyPolicyPage.dart';
import 'package:dios_delices/screens/legal/CGVPage.dart';
import 'package:dios_delices/screens/ProfilePage.dart';
import 'package:dios_delices/screens/LocationPage.dart';
    ...
    return Scaffold(
      ...
      body: ListView(
        ...
        children: [
          ...
          if (_currentRoleId == 5) ...[
            _sectionTitle('Préférences de livraison'),
            const SizedBox(height: 8),
            Container(
              decoration: BoxDecoration(
                color: AppColors.card,
              ...
              child: Column(
                children: [
                  ListTile(
                    ...
                    title: const Text('Distance max de livraison', style: TextStyle(fontSize: 15, fontWeight: FontWeight.w600)),
                    subtitle: Text('Distance maximale pour vos livraisons : ${_maxDeliveryDistance.toStringAsFixed(1)} km'),
                  ),
                  Padding(
