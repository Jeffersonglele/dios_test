                  ...
                  child: Column(
                    children: [
                      ...
                      ElevatedButton.icon(
                        ...
                        label: Text(l10n.identity_add_photo),
                      ),
                    ],
                  ),
                ),
                  ...
                  child: Column(
                    children: [
                      ...
                      ElevatedButton.icon(
                        ...
                        label: Text(l10n.identity_add_document),
                      ),
                    ],
                  ),
                ),
                    ...
                    onPressed: () async {
                      if (_userPhoto == null || _identityFile == null) {
                        ...
                        if (createResult == "success") {
                          ...
                          Toast(context, l10n.identity_naming_error, false);
                        }
                      }
                    },
